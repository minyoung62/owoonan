...
public class RecordApi {
    ...
    public ResponseEntity<Void> create(@RequestBody RecordCreateRequest request) {
        recordService.create(request.getRequestDtos(), request.getSaveDay() , getPrincipal().getUsername());
    ...
    public ResponseEntity<Void> update(@PathVariable Long recordId, @RequestBody RecordUpdateRequestDto request) {
